	...
	return (
		<div className="menu-contain-text-left">
			...
			<p class="text-large homepage-text-large_homepage-text-lg__24_gZ">
				...
				bring your ideas to life through expert
				<strong class="strong-font-normal">development</strong> and design
				services. We specialize in{" "}
				<strong class="strong-font-normal">desktop applications</strong>,
				<strong class="strong-font-normal">web applications</strong>, ERP
				systems and <strong class="strong-font-normal">APIs</strong>. We are
				committed to building long-term partnerships that evolve with your{" "}
